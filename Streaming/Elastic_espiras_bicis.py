...
class IndexDocument(beam.DoFn):
    ...
    def process(self,element):
        ...
        res = self.es.index(index='trafico_bicis_espiras',body=element)
...
def run(argv=None, save_main_session=True):
  ...
  parser.add_argument('--input_topic',
                      ...
                      default='projects/hackathon2-luis1201/topics/espiras_bicis',
  ...
  parser.add_argument('--input_subscription',
                      ...
                      default='projects/hackathon2-luis1201/subscriptions/streaming_espiras_bicis',
  ...
  bicisespiras = p | beam.io.ReadFromPubSub(subscription=known_args.input_subscription)

  # Print messages received
 
  
  
  bicisespiras = ( bicisespiras | beam.ParDo(LocationConcat()))
  
  bicisespiras | 'Print Quote' >> beam.Map(print)
  
  # Store messages on elastic
  bicisespiras | 'trafico bicis espiras' >> beam.ParDo(IndexDocument())
